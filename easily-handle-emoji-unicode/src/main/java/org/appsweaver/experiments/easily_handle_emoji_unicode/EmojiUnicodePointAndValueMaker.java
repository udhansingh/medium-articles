...
public class EmojiUnicodePointAndValueMaker {
	...
	// Web page that maintains the unicode emoji listing
	static final String unicodeListingUrl = "https://unicode.org/emoji/charts/full-emoji-list.html";
	
	public List<UnicodePointEntry> build() throws IOException {
